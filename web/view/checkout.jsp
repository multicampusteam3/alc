						...
						<tbody>
							<tr class="rem1">
								...
								<td class="invert-image">
									<a href="single.html">
										<img src="<c:url value="/resource/images/s1.jpg" />" alt=" " class="img-responsive">
									</a>
								</td>
								<td class="invert">
									<div class="quantity">
							...
							<tr class="rem2">
								...
								<td class="invert-image">
									<a href="single.html">
										<img src="<c:url value="/resource/images/s5.jpg" />" alt=" " class="img-responsive">
									</a>
								</td>
								<td class="invert">
									<div class="quantity">
							...
							<tr class="rem3">
								...
								<td class="invert-image">
									<a href="single.html">
										<img src="<c:url value="/resource/images/s2.jpg" />"  alt=" " class="img-responsive">
									</a>
								</td>
								<td class="invert">
									<div class="quantity">
