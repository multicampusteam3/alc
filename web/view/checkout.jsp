		...
		<div class="inner-sec-shop px-lg-4 px-3">
					...
					<tbody>
						<tr class="rem1">
							...
							<td class="invert-image"><a href="single.html"> <img
									src="<c:url value="/resource/images/s1.jpg" />" alt=" "
						...
						<tr class="rem2">
							...
							<td class="invert-image"><a href="single.html"> <img
									src="<c:url value="/resource/images/s5.jpg" />" alt=" "
									class="img-responsive">
							</a></td>
							<td class="invert">
								<div class="quantity">
						...
						<tr class="rem3">
							...
							<td class="invert-image"><a href="single.html"> <img
									src="<c:url value="/resource/images/s2.jpg" />" alt=" "
									class="img-responsive">
							</a></td>
							<td class="invert">
								<div class="quantity">
			...
			<div class="checkout-left row">
				<div class="col-md-4 checkout-left-basket">
					...
					<ul>
						<li>Product1 <i>-</i> <span>$281.00 </span>
						</li>
						<li>Product2 <i>-</i> <span>$325.00 </span>
						</li>
						<li>Product3 <i>-</i> <span>$325.00 </span>
						</li>
						<li>Total Service Charges <i>-</i> <span>$55.00</span>
						</li>
						<li>Total <i>-</i> <span>$986.00</span>
						</li>
					</ul>
				</div>
