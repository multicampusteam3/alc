...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resource/css/flexslider.css">
...
<body>
	<div class="banner-top container-fluid" id="home">
							...
							<div class="col-lg-4 single-right-left ">
									<div class="grid images_3_of_2">
										<div class="flexslider1">
											...
											<ul class="slides">
												<li data-thumb="/resource/images/d2.jpg" />
													<div class="thumb-image"> <img src="<c:url value="/resource/images/d2.jpg" />" data-imagezoom="true" class="img-fluid" alt=" "> </div>
												</li>
												<li data-thumb="/resource/images/d1.jpg" />
													<div class="thumb-image"> <img src="<c:url value="/resource/images/d1.jpg" />" data-imagezoom="true" class="img-fluid" alt=" "> </div>
												</li>
												<li data-thumb="/resource/images/d3.jpg" />
													<div class="thumb-image"> <img src="<c:url value="/resource/images/d3.jpg" />" data-imagezoom="true" class="img-fluid" alt=" "> </div>
												</li>
											</ul>
													...
													<div class="bootstrap-tab-text-grids">
														<div class="bootstrap-tab-text-grid">
															<div class="bootstrap-tab-text-grid-left">
																<img src="<c:url value="/resource/images/team1.jpg" />" alt=" " class="img-fluid">
															</div>
		...
		<!-- single -->
		<script src="<c:url value="/resource/js/imagezoom.js" />">
		<!-- single -->
		<!-- script for responsive tabs -->
		<script src="<c:url value="/resource/js/easy-responsive-tabs.js" />">
		<script>
			$(document).ready(function () {
		...
		<!-- FlexSlider -->
		<%-- <script src="<c:url value="/resource/js/flexslider.js" />">
		<script>
