...
<body>
	<%-- <div class="banner-top container-fluid" id="home">
								...
								<div class="tab4">
									<div class="pay_info row">
										<div class="col-md-6 tab-grid">
											<img class="pp-img" src="<c:url value="/resource/images/paypal.png" />" alt="Image Alternative text" title="Image Title">
		...
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resource/css/creditly.css" media="all" />
