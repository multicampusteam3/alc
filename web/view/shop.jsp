...
<head>
<title>Goggles Ecommerce Category Bootstrap responsive Web
...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/resource/css/login_overlay.css">
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/resource/css/style6.css">
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/resource/css/shop.css">
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/resource/css/owl.carousel.css">
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/resource/css/owl.theme.css">
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/resource/css/style.css">

<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/resource/css/easy-responsive-tabs.css">

<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/resource/css/fontawesome-all.css">
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/resource/css/jquery-ui1.css">
			...
			<div class="row">
				...
				<div class="col-md-6 logo-w3layouts text-center">
					<h1 class="logo-w3layouts">
						<a class="navbar-brand" href="index.html"> ALC </a>
					</h1>
				</div>
				...
				<div class="col-md-3 top-info-cart text-right mt-lg-4">
					<c:choose>
						...
						<c:otherwise>
							<ul class="cart-inner-info">
								<li class="button-log">${login_user.user_id },welcome<a
									class="btn-open" href="logout.alc"> <span
										class="fa fa-user" aria-hidden="true"></span>
								</a>
								</li>
							...
							<div class="login p-5 bg-dark mx-auto mw-100">
								<form action="login.alc" method="post">
									<div class="form-group">
										<label class="mb-2">ID</label> <input type="text"
											class="form-control" id="idInputId" name="id"
											aria-describedby="emailHelp" placeholder="" required="">
										<small id="emailHelp" class="form-text text-muted">환영합니다.
											아이디를 입력해 주세요.</small>
									</div>
									<div class="form-group">
										<label class="mb-2">Password</label> <input type="password"
											class="form-control" id="loginpw" name="pw" placeholder=""
											required="">
									</div>
						...
						<div class="wrap">
							...
							<div class="login p-5 bg-dark mx-auto mw-100">
								<form action="#" method="post">
									<div class="form-group">
										<label class="mb-2">ID</label> <input type="text"
											class="form-control" id="exampleInputId" name="user_id"
											aria-describedby="idHelp" placeholder="" required="">
										<small id="emailHelp" class="form-text text-muted">아이디를
											입력해 주세요.</small>
									</div>
									<div class="form-group">
										<label class="mb-2">Password</label> <input type="password"
											class="form-control" id="regpw" name="pw" placeholder=""
											required=""> <small id="passwordHelp"
											class="form-text text-muted">8자리 이상 비밀번호를 입력해 주세요.</small>

									</div>
									<div class="form-group">
										<label class="mb-2">Password Check</label> <input
											type="password" class="form-control"
											id="exampleInputPassword2" placeholder="" required="">
										<small id="passwordHelp" class="form-text text-muted">비밀번호를
											다시 한번 입력해 주세요.</small>
									</div>
									<div class="form-group">
										<label class="mb-2">Name</label> <input type="text"
											class="form-control" id="exampleInputName" name="name"
											placeholder="" required=""> <small id="nameHelp"
											class="form-text text-muted">본인의 성함을 입력해 주세요.</small>
									</div>
									<div class="form-group">
										<label class="mb-2">Addresss</label> <input type="text"
											class="form-control" id="exampleInputAddress" name="address"
											placeholder="" required=""> <small id="addressHelp"
											class="form-text text-muted">기본 배송 주소를 입력해 주세요.</small>
									</div>
									<div class="form-check mb-2">
										<input type="checkbox" class="form-check-input"
											id="exampleCheck2"> <label class="form-check-label"
											for="exampleCheck1">위 약관에 동의합니다.</label>
									</div>
									<br>
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav nav-mega mx-auto">
						<li class="nav-item"><a class="nav-link ml-lg-0"
							href="main.alc">전체 </a></li>
						<li class="nav-item"><a class="nav-link"
							href="shop.alc?sec=bg_soju">소주</a></li>
						<li class="nav-item"><a class="nav-link" href="#">막걸리</a></li>
						<li class="nav-item active"><a class="nav-link"
							href="shop.alc?sec=bg_beer">맥주 <!-- <span class="sr-only">(current)</span> -->
						</a></li>
						<li class="nav-item"><a class="nav-link" href="#">위스키</a></li>
						<li class="nav-item"><a class="nav-link" href="#">보드카</a></li>
						<li class="nav-item"><a class="nav-link" href="#">와인</a></li>
		...
		<div class="container-fluid px-lg-5 px-3">
			...
			<div class="copyright-w3layouts mt-4">
				<p class="copy-right text-center ">
					&copy; 2018 Goggles. All Rights Reserved | Design by <a
